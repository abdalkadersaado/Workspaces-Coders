...
<div class="container-fluid" >
		...
		@endif
			...
			<div class="dropdown text-right" id="avatar-dropdown">
				  ...
				  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
				    ...
				    <a class="dropdown-item" href="/workspaces/{{Auth::user()->username}}"><span class="fa fa-tachometer"></span>   Dashboard</a>
	...
	<div class="row" id="project-header">
		<div class="col-sm-4 ">
			<a class="btn control-button" href="{{route('showchanges',['user'=> $workspace->author->username, 'workspace' => $workspace->id])}}"> All Changes</a>
		...
		<div class="col-sm-2">
			...
			<button class="btn control-button " id="deleteBtn">
	...
	<div id="details">
		...
		<div class="row md-12">
			...
			<div class="col-md-3 all-section changes">
				<div class="details-section-header">History 
					<span class="pull-right meta-count">{{count($workspace->changes)}} Changes Made to This project</span>
				</div>
