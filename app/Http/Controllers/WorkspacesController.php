...
class WorkspacesController extends Controller
{
	...
	public function show_history(User $user,Workspace $workspace){

		//update the views 
		//update views 
		$workspace->increment('views');
		//pass items 
		return view('projects.history',compact('workspace','user'));
	}
    ...
    public function showchanges(User $user,Workspace $workspace)
    {
        $workspace->increment('views');
		//pass items 
		return view('projects.show',compact('workspace','user'));
